...
class ProductDescription:
    def __init__(self, page: ft.Page):
        ...
        self.description_db = ('O Alho Francês (Allium ampeloprasum) é um dos membros da família das cebolas. Tem uma '
                               'forma cilíndrica, alargando-se em folhas que crescem sobrepostas umas nas outras. É '
                               'constituído por uma parte branca - o fuste (zona subterrânea) - que é a mais usada na '
                               'culinária (guisados, tartes e gratinados), e uma parte verde (folhas aéreas) que deve '
        ...
        self.button_enter = ft.ElevatedButton("Edite o produto",
                                              on_click=lambda _: print("Insiriu o produto na Base de Dados"))

        self.image_insert_product = ft.Image(src=f"products/alho_frances.png", width=200, height=200,
                    ...
                    controls=[
                        ft.Column(
                            controls=[
                                ...
                                ft.Column(width=230, height=400,
                                          controls=[
