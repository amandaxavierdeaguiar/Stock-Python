...
class ProductNew():
    ...
    def __init__(self, page: ft.Page):
        ...
        category_list = ['Vegetais', 'Fruta', 'Talho', 'Peixaria', 'Padaria e Pastelaria', 'Charcutaria', 'Higiene e Beleza', 'Especiarias', 'Congelados', 'Limpeza', 'Bebé', 'Livraria e Papelaria', 'Casa, Bricolage e Jardim', 'Bebidas e Garrafeira', 'Lacticínios e Ovos', 'Bio e Intolerâncias', 'Mercearia']
        ...
        brand_list = ['Marca Própria','Milaneza', 'Barilla','Nacional','Cigala','Garofalo','Bom Petisco','Baci','Starbucks','Kinder','Tritão','Compal','Fula','Lays','Sidul','Nobre','Gallo','Oliveira da Serra']
        ...
        self.button_image = ft.ElevatedButton(text='Insira a Imagem', on_click=lambda _:file_picker.pick_files (allow_multiple = False, allowed_extensions=['jpg', 'jpeg', 'png']))
